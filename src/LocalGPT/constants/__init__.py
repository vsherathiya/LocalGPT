...
SOURCE_DIRECTORY = os.path.join(ROOT_DIRECTORY, "artifact", "Data")
...
# # Uses 5 GB of VRAM (Most Accurate of all models)

# EMBEDDING_MODEL_NAME = "intfloat/e5-large-v2" 
# # Uses 1.5 GB of VRAM (A little less accurate than instructor-large)

# EMBEDDING_MODEL_NAME = "intfloat/e5-base-v2" 
# # Uses 0.5 GB of VRAM (A good model for lower VRAM GPUs)

# EMBEDDING_MODEL_NAME = "all-MiniLM-L6-v2" 
# # Uses 0.2 GB of VRAM (Less accurate but fastest - only requires 150mb of vram)
...
#===================================8GB VRAM Graphics Cards (RTX 6000, RTX A6000 and other 48GB VRAM GPUs) ===================================
